...
INSERT
INTO ORDERS
(ORDER_CODE,USER_ID,STATUS,TOTAL_AMOUNT,DELIVERY_FEE,COUPON_ID)
SELECT * FROM CSVREAD('classpath:/sample-data/orders.csv');

INSERT
INTO ORDER_ITEM
(ORDERS_ID,ITEM_ID,QUANTITY)
SELECT * FROM CSVREAD('classpath:/sample-data/orderItems.csv');